...
/*Görev 1: macSkoru()
  ...
  skor1 bir closure skor2 bir scope , skor1 iç fonksiyon skor2 dışardaki fonksiyon..

  2. Hangisi bir closure kullanmaktadır? Nasıl tarif edebilirsin? (yarınki derste öğreneceksin :) )

  skor1 clousure kullanmakta,
...
function takimSkoru() {
  var minScore = 10;
  var maxScore = 25;
  var sonuc= Math.floor(Math.random() * (maxScore - minScore + 1)) + minScore;
  return sonuc;
}

var ceyrek =  takimSkoru();
console.log("Çeyrek Skoru: " + ceyrek ;
...
*/function takimSkoru(ceyrek, evSahibi, konukTakım) {
  var minScore = 10;
  var maxScore = 25;

  var evSahibi = Math.floor(Math.random() * (maxScore - minScore + 1)) + minScore;
  var konukTakım = Math.floor(Math.random() * (maxScore - minScore + 1)) + minScore;
